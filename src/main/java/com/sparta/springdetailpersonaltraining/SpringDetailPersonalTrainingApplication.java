package com.sparta.springdetailpersonaltraining;
...
public class SpringDetailPersonalTrainingApplication {

    public static void main(String[] args) {
        SpringApplication.run(SpringDetailPersonalTrainingApplication.class, args);
    }
    //    # main 아래에 삽입
    @PostConstruct
    public void started() {
